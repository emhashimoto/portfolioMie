...
```{r, fig.align='center', out.height='60%', fig.cap='Gráfico de barras da média do salário médio por ano'}
...
```{r, fig.align='center', out.height='60%', fig.cap='Gráfico de dispersão'}
tabela_microdados_vinculos |> 
